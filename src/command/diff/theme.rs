    ...
    pub fn midnight() -> Self {
        Self {
            ...
            syntax: SyntaxColors {
                ...
                function_macro: Color::Rgb(127, 209, 255),
                r#type: Color::Rgb(164, 183, 255),
                variable_builtin: Color::Rgb(142, 212, 255),
                variable_member: Color::Rgb(168, 214, 255),
                module: Color::Rgb(164, 183, 255),
                operator: Color::Rgb(142, 212, 255),
                tag: Color::Rgb(142, 212, 255),
                attribute: Color::Rgb(168, 214, 255),
                label: Color::Rgb(164, 183, 255),
                punctuation: Color::Rgb(110, 133, 167),
                default_text: Color::Rgb(232, 241, 255),
            },
            diff: DiffColors {
                added_bg: Color::Rgb(21, 53, 38),
                added_gutter_bg: Color::Rgb(16, 42, 31),
                added_gutter_fg: Color::Rgb(105, 214, 154),
                deleted_bg: Color::Rgb(71, 38, 42),
                deleted_gutter_bg: Color::Rgb(55, 27, 30),
                deleted_gutter_fg: Color::Rgb(255, 142, 142),
                context_bg: Color::Rgb(15, 27, 45),
                empty_placeholder_fg: Color::Rgb(53, 85, 120),
                added_word_bg: Color::Rgb(16, 42, 31),
                deleted_word_bg: Color::Rgb(55, 27, 30),
            },
            ui: UiColors {
                ...
                line_number: Color::Rgb(86, 115, 154),
                bg: Color::Rgb(8, 17, 31),
                footer_branch_bg: Color::Rgb(14, 27, 46),
                footer_branch_fg: Color::Rgb(127, 209, 255),
                status_added: Color::Rgb(90, 209, 136),
                status_modified: Color::Rgb(183, 148, 246),
                status_deleted: Color::Rgb(255, 139, 139),
                stats_added: Color::Rgb(90, 209, 136),
                stats_removed: Color::Rgb(255, 139, 139),
                ...
                search_match_fg: Color::Rgb(238, 244, 255),
                search_current_bg: Color::Rgb(127, 209, 255),
                search_current_fg: Color::Rgb(8, 17, 31),
            },
        }
    }
...
mod tests {
    ...
    fn default_theme_is_midnight_without_terminal_probe() {
        ...
        assert_eq!(theme.ui.bg, Color::Rgb(8, 17, 31));
    }
